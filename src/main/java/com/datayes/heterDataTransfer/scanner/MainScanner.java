...
public class MainScanner extends Thread {
    ...
    public String createTableStatement(String tableName) {
        ...
        result = result.substring(0, index1) + tableName + result.substring(index2+1);
